            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
                ...
                >
                  ...
                  <div className="flex items-center gap-4 mb-4">
                      <h2 className="text-4xl md:text-5xl font-semibold w-full md:w-1/2 bg-gradient-to-r from-white via-[#cfe6ff] to-primary bg-clip-text text-transparent">
                          Custom Built Never Template Based
                      </h2>
                      <p className="text-gray-300 border-l-4 border-[#f2c14e] pl-6 pr-2 w-full md:w-1/2">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    >
                        <div className="text-5xl font-bold bg-gradient-to-r from-[#fff4d6] via-[#f7d488] to-[#f2c14e] bg-clip-text text-transparent drop-shadow-[0_2px_6px_rgba(0,0,0,0.45)]"> Honest Timelines Always </div>
                    ...
                    <motion.div
                        ...
                        className="relative border border-primary rounded-tr-[6rem] p-10 group transition-all duration-500"
                    >
                        <div className="text-5xl font-bold bg-gradient-to-r from-[#fff4d6] via-[#f7d488] to-[#f2c14e] bg-clip-text text-transparent drop-shadow-[0_2px_6px_rgba(0,0,0,0.45)]"> Transparent Pricing Upfront</div>
                        <p className="mt-4 text-gray-300 leading-relaxed">
