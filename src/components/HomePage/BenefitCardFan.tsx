        ...
        <div className="flex justify-center items-center gap-3 sm:gap-4 lg:gap-6 [perspective:1500px]">
            {services.map((service, index) => {
                ...
                return (
                    ...
                    >
                        <div
                            className={`bg-white/5 backdrop-blur-xl rounded p-4 sm:p-6 lg:p-8 shadow-2xl h-full min-h-[280px] sm:min-h-[360px] lg:min-h-[420px] flex flex-col justify-between relative overflow-hidden border transition-colors duration-500 ${
                                isActive
                        ...
                        >
                            ...
                            <div className="relative z-10 flex-1">
                                <h4 className="text-sm sm:text-xl lg:text-2xl font-bold mb-2 sm:mb-3 uppercase lg:mb-4 px-1 sm:px-2 tracking-wide bg-gradient-to-r from-white via-[#cfe6ff] to-primary bg-clip-text text-transparent">
                                    {service.title}
                                </h4>
                                <p className="text-xs sm:text-sm lg:text-base text-gray-400 leading-relaxed px-1 sm:px-2">
                                    {service.description}
                                </p>
                            </div>
                        </div>
