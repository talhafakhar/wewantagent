...
const HeroSection = () => {
    ...
    return (
        <motion.section
            ...
            style={{ backgroundImage: "url('/assets/services/hero -bg-services.webp')" }}
        >
            <div className="absolute inset-0 bg-black/60"/>
            <div className="px-8 flex flex-col justify-center items-start min-h-screen max-w-7xl mx-auto">
                <Navbar/>
                <motion.div
                    variants={container}
                    initial="hidden"
                ...
                >
                    <div className="flex items-center justify-between">
                        <div className="text-start">
                            <motion.h1
                                variants={item}
                                className="text-5xl md:text-[78px] font-semibold text-white max-w-4xl"
                            >
                            ...
                            >
                                Transforming Ideas into Intelligent Solutions with Our Expert AI Development Services.
                            </motion.p>
                            <div className="mt-10 ">
                                <motion.button
                                    variants={{
  ...
  <span className="relative z-10 flex h-full w-full items-center justify-center text-nowrap bg-black rounded-sm">
    BOOK A FREE CONSULTATION
                        ...
                        <motion.div
                            variants={item}>
                            <Image
                                src="/assets/services/aiDevelopment.webp"
                                alt="AI Development"
                                width={600}
                                height={600}
                                className="md:mb-16 w-[500px] md:w-[700px] object-contain"
                            />
                        </motion.div>
